...
export const LINK_NODES: Record<LinkNodeId, LinkNode> = {
  home: {
    ...
    name: "Mount Kailash",
    path: "/",
    blurb: "Caribbean clinical wellness medicine from Saint Lucia.",
    trail: [],
  ...
  shop: {
    ...
    path: "/shop",
    blurb: "Browse wildcrafted Saint Lucia tinctures, capsules, teas, and raw wellness medicine.",
    trail: ["shop"],
  ...
  school: {
    id: "school",
    name: "Herbal Physician Certification — School of Wellness Medicine",
  ...
  retreats: {
    ...
    path: "/retreats",
    blurb: "Spend a week in the volcanic highlands on a guided wellness medicine immersion.",
    trail: ["retreats"],
    related: ["the-answer", "school", "webinars"],
  },
  webinars: {
    id: "webinars",
    name: "Wellness Medicine Webinars with Priest Kailash",
    path: "/webinars",
