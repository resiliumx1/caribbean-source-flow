...
const Wholesale = () => {
  ...
  return (
    <main className="min-h-screen pt-0">
      <SEOHead title="Caribbean Botanical Wholesale | Mount Kailash" description="Wholesale Caribbean botanicals with full COA documentation. Quick US delivery from Miami. Custom solutions for clinics, retailers, and wellness brands." path="/wholesale" />
