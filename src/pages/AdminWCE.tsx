...
import {
  ...
  Menu, X, Share2, Handshake, LineChart, Link2,
} from "lucide-react";
...
import WceCampaignLinks from "@/components/admin/wce/WceCampaignLinks";
...
const GROUPS = [
  {
    ...
    items: [
      ...
      { key: "campaign-links", label: "Campaign Links", Icon: Link2, Component: WceCampaignLinks },
    ],
  },
  {
    group: "Programme",
