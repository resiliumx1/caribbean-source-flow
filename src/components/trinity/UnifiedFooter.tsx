...
export function UnifiedFooter() {
  return (
    <footer style={{ background: '#0a0a0a', color: '#f2ead8' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, color: '#f2ead8' }}>Mount Kailash</div>
                <div style={{ fontSize: '12px', color: '#8a8070' }}>Rejuvenation Centre</div>
              </div>
            </div>
            <p style={{ fontFamily: "'Jost', sans-serif", fontWeight: 300, fontSize: '14px', color: '#8a8070', marginBottom: '16px', lineHeight: 1.6 }}>
          ...
          {/* Shop Column */}
          <div>
            <h3 style={{ fontFamily: "'Jost', sans-serif", fontWeight: 500, color: '#f2ead8', marginBottom: '16px' }}>Shop</h3>
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={item.label}>
                  <Link to={item.href} style={{ color: '#8a8070', fontFamily: "'Jost', sans-serif", fontWeight: 300 }} className="hover:text-[#c9a84c] transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 style={{ fontFamily: "'Jost', sans-serif", fontWeight: 500, color: '#f2ead8', marginBottom: '16px' }}>Practitioners</h3>
            <ul className="space-y-2 text-sm">
              {["Wholesale Portal", "Volume Pricing", "COA Documentation", "Private Labeling"].map((item) => (
                <li key={item}>
                  <Link to="/wholesale" style={{ color: '#8a8070', fontFamily: "'Jost', sans-serif", fontWeight: 300 }} className="hover:text-[#c9a84c] transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          {/* Visit Column */}
          <div>
            <h3 style={{ fontFamily: "'Jost', sans-serif", fontWeight: 500, color: '#f2ead8', marginBottom: '16px' }}>Visit</h3>
            <ul className="space-y-2 text-sm">
              {["Retreat Programs", "Group Immersions", "Solo Detox Retreats", "Book Consultation"].map((item) => (
                <li key={item}>
                  <Link to="/retreats" style={{ color: '#8a8070', fontFamily: "'Jost', sans-serif", fontWeight: 300 }} className="hover:text-[#c9a84c] transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
            ...
            <div className="mt-6 space-y-2 text-sm">
              <div className="flex items-center gap-2" style={{ color: '#8a8070' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(201,168,76,0.15)' }}>
        <div className="container mx-auto max-w-6xl px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4" style={{ fontSize: '12px', color: '#5a5048' }}>
