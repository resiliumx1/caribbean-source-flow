  ...
  return (
    <section style={{ background: 'var(--site-green-dark)', borderTop: '1px solid var(--site-border)', borderBottom: '1px solid var(--site-border)', padding: '80px 24px' }}>
      <div className="container mx-auto max-w-3xl text-center relative">
        <span style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, fontSize: '180px', color: 'var(--site-gold)', opacity: 0.15, position: 'absolute', top: '-80px', left: '-20px', lineHeight: 1, pointerEvents: 'none' }}>
          "
        </span>
        ...
        <cite style={{ fontFamily: "'Jost', sans-serif", fontWeight: 300, fontSize: '14px', color: 'var(--site-gold)', fontStyle: 'normal' }}>
