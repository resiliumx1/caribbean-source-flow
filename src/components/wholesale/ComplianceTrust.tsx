      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, fontSize: "clamp(2rem, 4vw, 44px)", color: "var(--site-footer-text)", marginBottom: "16px" }}>
              Documentation That Satisfies US & UK Customs
            </h2>
            <p style={{ fontSize: "16px", color: "var(--site-footer-muted)", fontWeight: 300, maxWidth: "640px", margin: "0 auto" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {trustBadges.map((badge) => (
              <div 
                ...
                style={{ background: "rgba(232,240,233,0.03)", border: "1px solid var(--site-border-subtle)" }}
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ background: "rgba(45,90,63,0.08)" }}>
                  <badge.icon className="w-10 h-10" style={{ color: "var(--site-gold)" }} />
                </div>
                <span style={{ fontWeight: 400, fontSize: "15px", color: "var(--site-footer-text)" }}>
                  {badge.label}
                </span>
                <span style={{ fontWeight: 300, fontSize: "13px", color: "var(--site-footer-muted)" }}>
                  {badge.desc}
                </span>
              </div>
            ))}
          ...
          <div 
            ...
            style={{ background: "rgba(0,0,0,0.35)", border: "1px solid var(--site-border-subtle)" }}
          >
            <div>
              ...
              <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, fontSize: "28px", color: "var(--site-footer-text)", marginBottom: "8px" }}>
                Caribbean Import Compliance Checklist
              </h3>
              <p style={{ fontWeight: 300, fontSize: "15px", color: "var(--site-footer-muted)", maxWidth: "480px", lineHeight: 1.7 }}>
            ...
            <div className="flex-shrink-0">
              <button 
                ...
                style={{ background: "var(--site-gold)", color: "var(--site-footer-text)", fontWeight: 600, fontSize: "16px" }}
              >
