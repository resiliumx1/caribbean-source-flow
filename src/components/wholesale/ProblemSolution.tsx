  ...
  return <section className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="section-subheader mx-auto">We understand the pain of unreliable supply chains. Here's how we're different.</p>
        </div>
        
        <div className="grid md:grid-cols-3 gap-8">
          {solutions.map((item, index) => <div key={index} className="solution-card group" style={{
          animationDelay: `${index * 100}ms`
        }}>
              {/* Image */}
              <div className="relative h-48 mb-6 rounded-lg overflow-hidden">
                <img src={item.image} alt={item.solution} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
