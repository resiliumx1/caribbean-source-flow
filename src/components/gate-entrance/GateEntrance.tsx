...
import { GateWreathSVG } from "./GateWreathSVG";
      ...
      <div className="sticky-hero">
        ...
        <div className="gate gate-left" ref={gateLeftRef}>
          <div className="wreath-half wreath-half-left">
            <GateWreathSVG className="wreath-half-svg wreath-svg-l" />
          </div>
        ...
        <div className="gate gate-right" ref={gateRightRef}>
          <div className="wreath-half wreath-half-right">
            <GateWreathSVG className="wreath-half-svg wreath-svg-r" />
          </div>
          <div className="gate-art">
            <GateArtRight />
          </div>
...
/** Center wreath SVG — the full 520×520 botanical wreath */
...
/** Each sprig has a unique design based on angle */
function WreathSprig({ angle }: { angle: number }) {
  switch (angle) {
    case 0:
      return (
        <>
      ...
      return (
        <>
          ...
          {[0, 30, 60, 90, 120, 150].map((r) => (
            <ellipse key={r} cx="260" cy="41" rx="4" ry="7.5" fill="rgba(201,169,110,0.16)" stroke="#c9a96e" strokeWidth="0.55" transform={`rotate(${r},260,41)`}/>
          ))}
      ...
      return (
        <>
          ...
          {[0, 36, 72, 108, 144].map((r) => (
            <ellipse key={r} cx="260" cy="43" rx="3.5" ry="8" fill="rgba(201,169,110,0.13)" stroke="#c9a96e" strokeWidth="0.5" transform={`rotate(${r},260,43)`}/>
          ))}
